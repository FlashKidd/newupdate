...
function renderList($type, $file, $url) {
    ...
    foreach ($list as $i => $entry) {
        ...
        echo "<li>";
        echo ($i + 1) . ". $label <strong>($type)</strong> ";
...
<body>
    <h2>Vodacom Cookies</h2>
    <ul>
        <?php renderList('voda', 'cookies.json', 'https://gameplay.mzansigames.club/my-winnings?display=tab3'); ?>
    </ul>
